...
public class SeparationEmpInfoRowModel extends BaseRowModel implements IBaseEmpInfoRowModel {
    ...
    @ExcelProperty(value = "HRP/TL NAME(EN)", index = 39)
    private String hrpEnName;

    @ExcelProperty(value = "Working Location", index = 40)
    private String location;

    @ExcelProperty(value = "Reporting Month", index = 41)
    private Date reportingMonth;

    @ExcelProperty(value = "Action Type", index = 42)
    private String actionType;

    @ExcelProperty(value = "Last Working Day", index = 43)
    ...
    public String getHrpEnName() {
        return hrpEnName;
    }

    public void setHrpEnName(String hrpEnName) {
        this.hrpEnName = hrpEnName;
    }
    ...
    public String toString() {
        return "SeparationEmpInfoRowModel{" +
                "category='" + category + '\'' +
                ", ipin='" + ipin + '\'' +
                ", cnName='" + cnName + '\'' +
                ", enName='" + enName + '\'' +
